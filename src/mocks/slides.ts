...
export const slides: Slide[] = [
  {
    ...
    elements: [
      ...
      },
      {
        ...
        height: 1,
        lineHeight: 1.2,
        content: '<p><strong><span style=\'font-size:  70px\'>RateMyServices</span></strong></p>',
        rotate: 0,
      ...
      },
      {
        ...
        width: 585,
        height: 56,
        content: '<p><span style=\'font-size:  24px\'>Discover, Review and Share</span></p>',
        rotate: 0,
        defaultFontName: 'Microsoft Yahei',
        defaultColor: '#333'
      },
  ...
  },
  {
    ...
    elements: [
      ...
      }, 
      {
        ...
        height: 140,
        content: '<p style=\'text-align: center;\'><strong><span style=\'color: #ffffff;\'><span style=\'font-size: 40px\'>Thank You</span></span></strong></p>',
        rotate: 0,
        defaultFontName: 'Microsoft Yahei',
        defaultColor: '#333',
        wordSpace: 5
