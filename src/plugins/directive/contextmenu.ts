...
const contextmenuListener = (el: HTMLElement, event: MouseEvent, binding: DirectiveBinding) => {
  ...
  // Remove the right-click menu and cancel the relevant event listeners
  ...
  // For the target node add menu activated the className
  el.classList.add('contextmenu-active')

  // When the page changes to remove the menu
