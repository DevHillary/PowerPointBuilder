...
// If the current set up by chromatic number is less than 10, the theme of the rest for the last topic similar color as the color of color
const updateTheme = () => {
  if (!chartRef.value) return
...
// Update the grid color, including the text part of the coordinates
