...
// Cutting area information (cutting area wide high percentage of the original image, in the original location)
...
// The underlying image position and size (mask area picture)
...
// The underlying image position and size style (mask area)
...
// Picture the top-level container position size (cut highlighted area)
...
// Picture the top-level container position size style (cutting highlighted area)
...
// The top image position and size style (cutting area picture)
...
// Initialize the cutting location information
...
// Perform cutting: calculation of image after cutting position and size and cut out information, and data synchronization
const handleClip = () => {
...
// Shortcuts to monitor: enter confirm cutting
...
// Calculate and update the data in the cutting area
const updateRange = () => {
  const retPosition = {
