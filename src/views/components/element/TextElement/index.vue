  ...
  >
    ...
    >
      ...
      >
        ...
        <!-- When the size is too large and line height is small, there will be a text height of overflow, cause drag area cannot be selected, so add the following nodes to avoid this situation -->
...
// The size of the listening text elements change, when the height changes, update the height to vuex
// If the height change is in the scaling operation, is waiting for scaling operation after the update again
