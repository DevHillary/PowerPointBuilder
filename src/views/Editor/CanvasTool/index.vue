  ...
  <div class="canvas-tool">
    ...
    <div class="add-element-handler">
      ...
      <FileInput @change="files => insertImageElement(files)">
        <Tooltip :mouseLeaveDelay="0" :mouseEnterDelay="0.5" title="Insert the picture">
      ...
      <Popover trigger="click" v-model:visible="shapePoolVisible">
        ...
        <Tooltip :mouseLeaveDelay="0" :mouseEnterDelay="0.5" title="Insert the shape">
      ...
      <Popover trigger="click" v-model:visible="linePoolVisible">
        ...
        <Tooltip :mouseLeaveDelay="0" :mouseEnterDelay="0.5" title="Insert the line">
      ...
      <Popover trigger="click" v-model:visible="chartPoolVisible">
        ...
        <Tooltip :mouseLeaveDelay="0" :mouseEnterDelay="0.5" title="Insert a chart">
      ...
      <Popover trigger="click" v-model:visible="tableGeneratorVisible">
        ...
        <Tooltip :mouseLeaveDelay="0" :mouseEnterDelay="0.5" title="Insert table">
          <IconInsertTable class="handler-item" />
        </Tooltip>
      </Popover>
      <Tooltip :mouseLeaveDelay="0" :mouseEnterDelay="0.5" title="Insert the formula">
    ...
    <div class="right-handler">
      ...
      <Tooltip :mouseLeaveDelay="0" :mouseEnterDelay="0.5" title="To adapt to the screen">
