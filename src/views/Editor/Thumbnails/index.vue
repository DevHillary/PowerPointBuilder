...
const handleClickSlideThumbnail = (e: MouseEvent, index: number) => {
  ...
  // Hold down the Ctrl key, click on the slide, click again on the selected page deselect
  ...
  // Hold down the Shift key, select all within the scope of the slides
...
// Set thumbnail toolbar focused state (only focus on the state, that part of the keyboard shortcuts to work)
...
// Drag and drop after adjustment order for data synchronization
...
const contextmenusThumbnailItem = (): ContextmenuItem[] => {
  return [
    ...
    { divider: true },
    {
      text: 'From the current screening',
      subText: 'Shift + F5',
