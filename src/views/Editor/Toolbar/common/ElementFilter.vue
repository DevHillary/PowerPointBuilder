...
const defaultFilters: FilterOption[] = [
  { label: 'The fuzzy', key: 'blur', default: 0, value: 0, unit: 'px', max: 10, step: 1 },
  ...
  { label: 'gray', key: 'grayscale', default: 0, value: 0, unit: '%', max: 100, step: 5 },
  ...
  { label: 'The opacity', key: 'opacity', default: 100, value: 100, unit: '%', max: 100, step: 5 },
]
