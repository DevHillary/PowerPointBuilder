<template>
  <div class="shape-style-panel">
    <div class="title">
      <span>Click on the replacement of shape</span>
      <IconDown />
    </div>
    ...
    <div class="row">
      ...
      >
        <SelectOption value="fill">Pure color fill</SelectOption>
    ...
    <template v-if="fillType === 'gradient'">
      <div class="row">
        <div style="flex: 2;">The starting point of colors:</div>
...
const updateTextAlign = (align: 'top' | 'middle' | 'bottom') => {
  ...
  const defaultText: ShapeText = {
    content: '',
    defaultFontName: 'Microsoft jas black',
    defaultColor: '#000',
    align: 'middle',
  }
