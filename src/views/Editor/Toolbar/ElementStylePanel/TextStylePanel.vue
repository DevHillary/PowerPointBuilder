  ...
  <div class="text-style-panel">
    ...
    <InputGroup compact class="row">
      ...
      >
        ...
        <SelectOptGroup label="The system font">
    ...
    <ButtonGroup class="row">
      ...
      <Popover trigger="click">
        ...
        <Tooltip :mouseLeaveDelay="0" :mouseEnterDelay="0.5" title="Text highlighted">
          <TextColorButton :color="richTextAttrs.backcolor" style="flex: 3;">
            <IconHighLight />
          </TextColorButton>
        </Tooltip>
      </Popover>
      <Tooltip :mouseLeaveDelay="0" :mouseEnterDelay="0.5" title="Increase the font size">
        <Button 
          class="font-size-btn"
          style="flex: 2;"
      ...
      <Tooltip :mouseLeaveDelay="0" :mouseEnterDelay="0.5" title="Reduce the font size">
        <Button 
          class="font-size-btn"
          style="flex: 2;"
    ...
    <CheckboxButtonGroup class="row">
      ...
      <Tooltip :mouseLeaveDelay="0" :mouseEnterDelay="0.5" title="The underline">
        <CheckboxButton 
          style="flex: 1;"
      ...
      <Tooltip :mouseLeaveDelay="0" :mouseEnterDelay="0.5" title="Delete the line">
        <CheckboxButton 
          style="flex: 1;"
    ...
    <CheckboxButtonGroup class="row">
      ...
      <Tooltip :mouseLeaveDelay="0" :mouseEnterDelay="0.5" title="The subscript">
        <CheckboxButton
          style="flex: 1;"
      ...
      <Tooltip :mouseLeaveDelay="0" :mouseEnterDelay="0.5" title="The inline code">
        <CheckboxButton
          style="flex: 1;"
      ...
      <Tooltip :mouseLeaveDelay="0" :mouseEnterDelay="0.5" title="reference">
        <CheckboxButton
          style="flex: 1;"
    ...
    <CheckboxButtonGroup class="row">
      ...
      <Tooltip :mouseLeaveDelay="0" :mouseEnterDelay="0.5" title="Brush format">
        <CheckboxButton
          style="flex: 1;"
      ...
      <Tooltip :mouseLeaveDelay="0" :mouseEnterDelay="0.5" title="hyperlinks">
        <Popover placement="bottomRight" trigger="click" v-model:visible="linkPopoverVisible">
          <template #content>
            <div class="link-popover">
              <Input v-model:value="link" placeholder="Please enter the hyperlinks" />
              <div class="btns">
                <Button size="small" :disabled="!richTextAttrs.link" @click="updateLink()" style="margin-right: 5px;">remove</Button>
    ...
    >
      ...
      <Tooltip :mouseLeaveDelay="0" :mouseEnterDelay="0.5" title="In the middle">
    ...
    <div class="row">
      <ButtonGroup style="flex: 15;">
        <Tooltip :mouseLeaveDelay="0" :mouseEnterDelay="0.5" title="bulleted">
          <Button
      ...
      <ButtonGroup style="flex: 15;">
        <Tooltip :mouseLeaveDelay="0" :mouseEnterDelay="0.5" title="Serial number">
          <Button
    ...
    <ButtonGroup class="row">
      <Tooltip :mouseLeaveDelay="0" :mouseEnterDelay="0.5" title="Decrease the indentation">
    ...
    <div class="row">
      <div style="flex: 2;">Word space:</div>
    ...
    <div class="row">
      <div style="flex: 2;">First line indentation:</div>
    ...
    <div class="row">
      <div style="flex: 2;">Text box filling:</div>
      <Popover trigger="click">
        <template #content>
          <ColorPicker
            :modelValue="fill"
...
// Note that there is a BUG of unknown reason, if the text after the bold text box height increases, the viewing area of the canvas positioning error will occur
// So when preset style command, will be bold command on the front of the plane, as far as possible avoid bold again after size increases
const presetStyles = [
  {
    label: 'The headlines',
    style: {
...
const updateLink = (link?: string) => {
  if (link) {
    ...
    if (!linkRegExp.test(link)) return message.error('Not the right web link address')
  }
