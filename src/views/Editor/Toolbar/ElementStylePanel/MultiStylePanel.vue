<template>
  <div class="multi-style-panel">
    ...
    <div class="row">
      ...
      >
        <SelectOption value="solid">Solid line border</SelectOption>
        <SelectOption value="dashed">The dashed frame</SelectOption>
      </Select>
    </div>
    <div class="row">
...
// Bulk changes fill color (table element for cell filling, audio elements for icon color)
