<template>
  <div class="slide-animation-panel">
    ...
    <Button style="width: 100%;" @click="applyAllSlide()">Applied to all</Button>
  </div>
</template>
...
const animations: Animations[] = [
  { label: 'There is no', value: 'no' },
  { label: 'The fading', value: 'fade' },
  { label: 'About time', value: 'slideX' },
  { label: 'Goes up and down', value: 'slideY' },
]

const { addHistorySnapshot } = useHistorySnapshot()

// When modified broadcast way of switch pages
...
// Switch to the current page page mode is applied to all pages
const applyAllSlide = () => {
