    ...
    <div class="configs">
      <div class="row">
        ...
        >
          ...
          <RadioButton style="width: 50%;" value="current">The current slide</RadioButton>
        </RadioGroup>
      </div>
      <div class="row">
        <div class="title">Number each page：</div>
        <Select 
          class="config-item"
          v-model:value="count"
        >
      ...
      <div class="row">
        <div class="title">Edge of the white space：</div>
        <div class="config-item">
          <Switch v-model:checked="padding" />
        </div>
      </div>
      <div class="tip">
        Note: if the print preview does not agree with the actual style，Please print in the pop-up window, check the background graphics options 】。
      </div>
    </div>
