...
// According to multiple element in whole range of canvas, border lines and zoom point location information
...
// Calculate a multiple-choice element whole range in the canvas
const setRange = () => {
