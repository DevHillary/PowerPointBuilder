...
export default (elementList: Ref<PPTElement[]>) => {
  ...
  const dragLineElement = (e: MouseEvent, element: PPTLineElement, command: OperateLineHandlers) => {
    ...
    // Get all the lines outside not rotating elements as adsorption eight zoom level
    ...
    document.onmousemove = e => {
      ...
      // The positions of the line starting point and end point in the editing area
      ...
      // Drag and drop the location of the beginning or end
      // Adsorption on the horizontal and vertical direction
      ...
      // Calculate the update the coordinates of starting point and end point elements based on their own position
