  ...
  <div class="base-view" :class="{ 'laser-pen': laserPen }">
    ...
    >
      <div class="content">
        ...
        <Tooltip :mouseLeaveDelay="0" :mouseEnterDelay="0.3" title="The brush tool">
          <IconWrite class="tool-btn" @click="writingBoardToolVisible = true" />
        </Tooltip>
        <Tooltip :mouseLeaveDelay="0" :mouseEnterDelay="0.3" title="The laser pen">
          <IconMagic class="tool-btn" :class="{ 'active': laserPen }" @click="laserPen = !laserPen" />
        </Tooltip>
        <Tooltip :mouseLeaveDelay="0" :mouseEnterDelay="0.3" title="The timer">
          <IconStopwatchStart class="tool-btn" :class="{ 'active': timerlVisible }" @click="timerlVisible = !timerlVisible" />
        </Tooltip>
        <Tooltip :mouseLeaveDelay="0" :mouseEnterDelay="0.3" title="The speaker view">
          <IconListView class="tool-btn" @click="changeViewMode('presenter')" />
        </Tooltip>
        <Tooltip :mouseLeaveDelay="0" :mouseEnterDelay="0.3" :title="fullscreenState ? 'Exit full screen' : 'Enter the full screen'">
        ...
        <Tooltip :mouseLeaveDelay="0" :mouseEnterDelay="0.3" title="End show">
...
const contextmenus = (): ContextmenuItem[] => {
  return [
    ...
    {
      text: 'The speaker view',
      handler: () => props.changeViewMode('presenter'),
    },
    { divider: true },
    {
      text: autoPlayTimer.value ? 'Cancel the automatic screening' : 'Automatic screening',
