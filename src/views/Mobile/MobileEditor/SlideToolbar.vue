<template>
  <div class="slide-toolbar">
    <div class="remark">
      <textarea
        :value="remark"
        placeholder="Click on the input speaker remarks"
    ...
    <div class="toolbar">
      ...
      <ButtonGroup class="row">
        <Button style="flex: 1;" @click="insertTextElement()"><IconFontSize class="icon" /> The text</Button>
        <Button style="flex: 1;">
          <FileInput @change="files => insertImageElement(files)">
            <IconPicture class="icon" />The picture
          </FileInput>
        </Button>
        <Button style="flex: 1;" @click="insertShapeElement('square')"><IconSquare class="icon" /> rectangular</Button>
        <Button style="flex: 1;" @click="insertShapeElement('round')"><IconRound class="icon" />circular</Button>
      </ButtonGroup>
    </div>
