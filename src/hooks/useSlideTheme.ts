...
export default () => {
  ...
  // Get all colors within a designated slides (main)
  ...
  // To create the original color and the corresponding relationship with new color table
  ...
  // Application of preset themes (all)
  ...
  // The current theme configuration is applied to all pages
